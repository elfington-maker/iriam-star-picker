...
const starMessages = [
  ...
  "That star just remembered it left the oven on.",
  "This star has been selected for additional screening.",
  "That star comes with a complimentary bread basket.",
  "This star has absolutely no idea how it got here.",
  "That star just rolled a natural 20 on being shiny.",
  "This star is currently accepting applications for a sidekick.",
  "That star has been asked to leave the aquarium.",
  "This star is wearing a fake mustache for reasons it cannot disclose.",
  "That star knows a shortcut. Do not follow it.",
  "This star has been nominated for Employee of the Month by itself.",
  "That star is three raccoons in a trench coat. Somehow.",
  "This star just put all its skill points into charisma.",
  "That star has been described by witnesses as 'suspiciously round.'",
  "This star comes with two batteries. It requires three.",
  "That star has a reservation under a fake name.",
  "This star has been staring at the loading screen for twenty minutes.",
  "That star just found the good scissors.",
  "This star is not angry. It is just disappointed.",
  "That star has been upgraded from 'probably fine' to 'mostly fine.'",
  "This star has a tiny briefcase full of important star business.",
  "That star just received a cease and desist from the moon.",
  "This star knows exactly what you did last summer, but thought it was hilarious.",
  "That star has been temporarily replaced by an equally qualified potato.",
  "This star has been selected to lead the conga line.",
  "That star brought snacks but will not share.",
  "This star is banned from using the office laminator.",
  "That star just put googly eyes on something important.",
  "This star is the proud owner of seventeen identical hats.",
  "That star has been asked repeatedly to stop pressing the big red button.",
  "This star is currently experiencing technical difficulties. Please applaud.",
  "That star has a tiny sword and absolutely no training.",
  "This star was supposed to bring a responsible adult.",
  "That star has been assigned a quest it has no intention of completing.",
  "This star just learned what taxes are and would like to go back.",
  "That star brought a PowerPoint presentation nobody requested.",
  "This star has a permit. We don't know what the permit is for.",
  "That star just heard the boss music start.",
  "This star has been chosen as tribute. For what, nobody knows.",
  "That star knows exactly one magic spell. It makes toast.",
  "This star has been awake for twelve minutes and already needs a nap.",
  "That star has entered its mysterious trench coat era.",
  "This star was delivered to the wrong timeline.",
  "That star has a tiny emergency whistle and desperately wants to use it.",
  "This star just called dibs on the comfy chair.",
  "That star has been professionally inspected and deemed extremely star-shaped.",
  "This star just spent twenty minutes looking for something it was holding.",
  "That star has a treasure map, but the X just leads to another treasure map.",
  "This star has been accused of bringing main-character energy to a side quest.",
  "That star just pressed 'Remind Me Tomorrow' for the seventeenth time.",
  "This star is here for a good time, not a scientifically accurate time.",
];
